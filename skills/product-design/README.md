...
Product design skills help you review, critique, and improve digital product experiences before committing to redesign or implementation work. Use them when you need sharper judgment on usability, interaction, visual hierarchy, accessibility, onboarding, dashboards, or core flows.
...
Start with **product-design-review** when you need to:
...
Install the skill folder directly:

```bash
skills/product-design/product-design-review/
```
